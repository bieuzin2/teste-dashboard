...
def carregar_dados_excel(caminho_arquivo):
    ...
    Returns:
        tuple: Uma tupla contendo:
            - pd.DataFrame: DataFrame com os dados da aba 'Clientes'.
            - dict: Dicionário onde cada chave é o nome de um cliente e o valor é
                    outro dicionário com 'investimentos' e 'opcoes'.
    """
    try:
        ...
        if nome in xls.sheet_names:
            try:
                ...
                try:
                    ...
                    # ALTERAÇÃO: Garante que a coluna 'Quantidade' seja um número inteiro.
                ...
                # --- LÓGICA REFEITA: Extração da Carteira de Opções por Mês ---
